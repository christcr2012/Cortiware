...
function LoginForm() {
  ...
  useEffect(() => {
    const rememberedEmail = localStorage.getItem('tenant_remembered_email');
    if (rememberedEmail) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (rememberMe) {
      localStorage.setItem('tenant_remembered_email', email);
    } else {
      localStorage.removeItem('tenant_remembered_email');
    }
