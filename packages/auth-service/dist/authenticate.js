 ...
 */
export async function authenticateProvider(input, config) {
 ...
 */
export async function authenticateDeveloper(input, config) {
    const { email, password } = input;
    const emailLower = email.toLowerCase();
 ...
 */
export async function authenticateDatabaseUser(input, user, devModeConfig) {
 ...
 */
export async function authenticateEmergency(input, role, passwordHash) {
