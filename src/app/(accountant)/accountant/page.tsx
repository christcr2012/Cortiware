      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Pending Invoices</p>
          </div>
          ...
          >
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Monthly Expenses</p>
          </div>
          ...
          >
            ...
            <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Reports Generated</p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                ></div>
                <div>
                  <p className="text-sm" style={{ color: 'var(--text-primary)' }}>Accountant login successful</p>
                  <p className="text-xs font-mono" style={{ color: 'var(--text-tertiary)' }}>{accountantEmail}</p>
                </div>
              </div>
